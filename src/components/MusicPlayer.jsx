  ...
  return (
    <div className="flex flex-col items-center gap-2">
      ...
      >
        ...
        <div className="relative z-10 w-12 h-12 rounded-full glass border border-border flex items-center justify-center shadow-lg hover:scale-105 transition-transform">
          {isPlaying ? (
