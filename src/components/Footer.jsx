export default function Footer() {
  return (
    <footer className="py-20 px-6 bg-gradient-to-b from-cream to-cream-dark border-t border-border relative overflow-hidden">
      ...
      <div className="w-full max-w-3xl mx-auto text-center relative z-10">
        ...
        <h3 className="font-[family-name:var(--font-alex)] text-5xl text-primary mb-4">Hazal & Oğuz</h3>
        ...
        <p className="text-text-light/50 text-xs tracking-wider">© 2026 Hazal & Oğuz Nikah Davetiyesi</p>
      </div>
    </footer>
  )
}
