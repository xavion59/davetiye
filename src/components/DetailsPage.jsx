export default function DetailsPage() {
  return (
    <section className="h-screen w-full flex flex-col px-5 sm:px-8 py-8 bg-cream overflow-hidden">

      {/* Title */}
      <h2 className="font-[family-name:var(--font-alex)] text-4xl sm:text-5xl text-primary text-center mb-5 shrink-0">
        Düğün Detayları
      </h2>

      {/* 3 framed sections - equal height, fill remaining space */}
      <div className="flex-1 flex flex-col gap-4 min-h-0">

        {/* Date & Time */}
        <div className="flex-1 min-h-0 rounded-2xl border-[3px] border-primary bg-white/80 backdrop-blur-sm shadow-lg flex items-center gap-4 px-5">
          <div className="w-14 h-14 rounded-xl bg-gradient-to-br from-primary to-primary-light flex items-center justify-center shrink-0 shadow-md">
        ...
        {/* Venue */}
        <div className="flex-1 min-h-0 rounded-2xl border-[3px] border-primary bg-white/80 backdrop-blur-sm shadow-lg flex items-center gap-4 px-5">
          <div className="w-14 h-14 rounded-xl bg-gradient-to-br from-gold to-gold-light flex items-center justify-center shrink-0 shadow-md">
            <svg className="w-7 h-7 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
