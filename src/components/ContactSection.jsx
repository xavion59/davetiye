export default function ContactSection() {
  ...
  return (
    <section className="py-24 px-4 sm:px-6 bg-cream-dark relative overflow-hidden">
        ...
        <div className="flex justify-center animate-fade-in-up" style={{ animationDelay: '0.3s' }}>
          {contacts.map((contact) => (
            <a
              ...
              className="glass rounded-3xl p-8 border border-border shadow-xl flex items-center gap-5 hover:shadow-2xl hover:scale-[1.02] transition-all duration-500 w-full max-w-md"
            >
