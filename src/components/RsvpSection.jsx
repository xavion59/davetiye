...
export default function RsvpSection() {
  ...
  if (submitted) {
    return (
      <section className="w-full min-h-[90vh] flex items-center justify-center px-6 sm:px-10 py-16 bg-cream-dark">
        <div className="w-full max-w-2xl mx-auto border-[5px] border-primary rounded-3xl p-10 sm:p-14 bg-white/60 shadow-xl text-center">
