...
export default function HeroSection({ audioRef }) {
  ...
  return (
    <section className="relative min-h-screen w-full overflow-hidden border-[5px] border-gold m-0">
      ...
      <div className="absolute inset-0 z-10">
        ...
        <Draggable id="message" positions={positions} setPositions={setPositions} editing={editing}>
          <p className="text-2xl sm:text-3xl md:text-4xl text-gold leading-relaxed drop-shadow-lg text-center whitespace-pre-line"
            style={{ fontFamily: "'Lucida Calligraphy', 'Segoe Script', 'Apple Chancery', cursive", width: '90vw', maxWidth: '500px' }}>
            {'Bu güzel günde\nsevincimize ortak olmanız\nbizi çok mutlu eder.'}
          </p>
        </Draggable>
